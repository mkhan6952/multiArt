      ...
      <div className="c-inner row">
        ...
        <div className="col-lg-6 col-sm-12 c-content-r">
          <div className="c-para">
            ...
            <p>Twitter： @Multiart_io.</p>
          </div>
          <div className="c-para mt-5">
            <p>For cooperation , please contact us at </p>
            <p>Email： hello@multiart.io.</p>
          </div>

          {/* <div className="c-social-icon">
            <a className="icon-circle" href="#" target="_blank">
              <Icon className="ico" icon="typcn:social-twitter" />
            </a>
            <a className="icon-circle" href="#" target="_blank">
              <Icon className="ico" icon="ic:round-discord" />
            </a>
            <a className="icon-circle" href="#" target="_blank">
              <Icon className="ico" icon="ic:sharp-telegram" />
            </a>
            <a className="icon-circle" href="#" target="_blank">
              <Icon className="ico" icon="ri:medium-fill" />
            </a>
          </div> */}
